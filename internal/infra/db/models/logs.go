...
type Log struct {
	...
	TraceID   null.String `boil:"trace_id" json:"trace_id,omitempty" toml:"trace_id" yaml:"trace_id,omitempty"`
...
var LogWhere = struct {
	...
	TraceID   whereHelpernull_String
	...
	TraceID:   whereHelpernull_String{field: "\"logs\".\"trace_id\""},
	Timestamp: whereHelpertime_Time{field: "\"logs\".\"timestamp\""},
	Level:     whereHelperstring{field: "\"logs\".\"level\""},
	Service:   whereHelperstring{field: "\"logs\".\"service\""},
	Message:   whereHelperstring{field: "\"logs\".\"message\""},
	Metadata:  whereHelpernull_JSON{field: "\"logs\".\"metadata\""},
}
...
var (
	logAllColumns            = []string{"id", "trace_id", "timestamp", "level", "service", "message", "metadata"}
	logColumnsWithoutDefault = []string{"timestamp", "level", "service", "message"}
	logColumnsWithDefault    = []string{"id", "trace_id", "metadata"}
